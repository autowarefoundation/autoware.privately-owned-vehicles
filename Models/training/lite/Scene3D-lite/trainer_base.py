...
class DepthTrainerBase(ABC):
    ...
    def _build_pseudo_labeler(self):
        ...
        from preprocessing.scene3d.depth_anything_v2.depth_anything_v2.dpt import DepthAnythingV2
        ...
        checkpoint = f"preprocessing/scene3d/depth_anything_v2/depth_anything_v2_{encoder}.pth"
    ...
    def _maybe_resume(self):
        ...
        if not fine_tune:
            ...
            if "best" in ckpt:
                self.best_miou = float(ckpt["best"])
