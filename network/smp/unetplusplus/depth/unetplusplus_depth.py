...
class UnetPlusPlusDepth(DepthModel):
    ...
    Instead of having a segmentation head, it calls it a Depth Head, but the function is the same.
    It maps a N channel feature map to output classes (1 for depth estimation).
    """
