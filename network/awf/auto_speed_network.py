...
import sys
sys.path.append('../../')
from network.awf.auto_speed_backbone import AutoSpeedBackbone
from network.awf.auto_speed_neck import AutoSpeedNeck
from network.awf.auto_speed_head import AutoSpeedHead
from network.awf.auto_speed_layers import Conv
